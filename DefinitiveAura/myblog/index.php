...
<body>
    ...
    <header class="header">
        ...
        <nav class="header-nav">
            <a href="create_post.php" class="aa">
                <img src="images/mais2.png" alt="login" class="icon2">
            </a>
            <a href="login.php" class="aa">
                <img src="images/login1.png" alt="login" class="icon2">
            </a>
    ...
    <div class="container">
        ...
        <!-- Seção principal para o post grande e outros menores -->
    ...
    ");
                if ($sql_query->num_rows != 0) {
                    while ($post = $sql_query->fetch_assoc()) {
                        ...
                        // Perfil do usuário e nome à esquerda
                        ...
                        // Primeira linha da descrição do post
                        $description_line = explode("\n", htmlspecialchars($post['content']))[0]; // Captura a primeira linha da descrição
